...
Copy cgi/* to your Apache CGI directory, 
	ensure 755 permissions
	edit top of CGI file, ensure it points to your config file of choice
	test by running wiggleCGI.py on the command line, no params
